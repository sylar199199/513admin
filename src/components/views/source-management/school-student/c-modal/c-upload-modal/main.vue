<template>
  ...
  >
    <el-row class="content">
      ...
      <el-col :span="12">
        <base-upload
          suffix-src="/student/importExcel"
          :limit-size="10"
          accept=".xls,.xlsx"
      ...
      <el-col :span="6">
        <a :href="downloadUrl" download="studentTemplate.xlsx">点击下载模板</a>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="6">
...
import execelTemplate from '@assets/images/school-student-excel-template.png'
...
export default {
  ...
  computed: {
    ...mapState('school-student', {
      ...
      downloadUrl: state => state.studentUrl,
    }),
  },
  methods: {
    ...mapActions('school-student', ['getAllStudentList']),
